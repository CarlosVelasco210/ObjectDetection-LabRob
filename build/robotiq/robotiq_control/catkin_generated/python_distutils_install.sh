...
echo_and_run cd "/home/wata/LabRob2_ws/src/robotiq/robotiq_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/wata/LabRob2_ws/src/robotiq/robotiq_control/setup.py" \
     \
    build --build-base "/home/wata/LabRob2_ws/build/robotiq/robotiq_control" \
    install \
    --root="${DESTDIR-/}" \
