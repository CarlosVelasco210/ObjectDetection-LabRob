...
echo_and_run cd "/home/wata/LabRob2_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/wata/LabRob2_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/wata/LabRob2_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
