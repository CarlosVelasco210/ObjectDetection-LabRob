...
(cl:defclass <KeyPoint3DArray> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type (cl:vector ultralytics_ros-msg:KeyPoint3D)
   :initform (cl:make-array 0 :element-type 'ultralytics_ros-msg:KeyPoint3D :initial-element (cl:make-instance 'ultralytics_ros-msg:KeyPoint3D)))
   (frame_id
    :reader frame_id
    :initarg :frame_id
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint3DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint3DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<KeyPoint3DArray> is deprecated: use ultralytics_ros-msg:KeyPoint3DArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <KeyPoint3DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ultralytics_ros-msg:KeyPoint3D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<KeyPoint3DArray>)))
  ...
  "ultralytics_ros/KeyPoint3DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'KeyPoint3DArray)))
  "Returns string type for a message object of type 'KeyPoint3DArray"
  "ultralytics_ros/KeyPoint3DArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyPoint3DArray>)))
  ...
  (cl:format cl:nil "# represents all the keypoints for human pose estimation in meters~%~%ultralytics_ros/KeyPoint3D[] data~%~%# frame reference~%string frame_id~%================================================================================~%MSG: ultralytics_ros/KeyPoint3D~%# one keypoint for human pose estimation~%~%# id of the keypoint~%int32 id~%~%# 3D point in meters~%geometry_msgs/Point point~%~%# conf of the keypoint~%float64 score~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyPoint3DArray)))
  "Returns full string definition for message of type 'KeyPoint3DArray"
  (cl:format cl:nil "# represents all the keypoints for human pose estimation in meters~%~%ultralytics_ros/KeyPoint3D[] data~%~%# frame reference~%string frame_id~%================================================================================~%MSG: ultralytics_ros/KeyPoint3D~%# one keypoint for human pose estimation~%~%# id of the keypoint~%int32 id~%~%# 3D point in meters~%geometry_msgs/Point point~%~%# conf of the keypoint~%float64 score~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
