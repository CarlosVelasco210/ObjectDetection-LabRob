...
(cl:defclass <KeyPoint2D> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (point
    :reader point
    :initarg :point
    :type ultralytics_ros-msg:Point2D
    :initform (cl:make-instance 'ultralytics_ros-msg:Point2D))
   (score
    :reader score
    :initarg :score
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<KeyPoint2D> is deprecated: use ultralytics_ros-msg:KeyPoint2D instead.")))
...
(cl:defmethod point-val ((m <KeyPoint2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:point-val is deprecated.  Use ultralytics_ros-msg:point instead.")
  (point m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KeyPoint2D>)))
  ...
  (cl:format cl:nil "# one keypoint for human pose estimation~%~%# id of the keypoint~%int32 id~%~%# 2D point in pixels~%ultralytics_ros/Point2D point~%~%# conf of the keypoint~%float64 score~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KeyPoint2D)))
  "Returns full string definition for message of type 'KeyPoint2D"
  (cl:format cl:nil "# one keypoint for human pose estimation~%~%# id of the keypoint~%int32 id~%~%# 2D point in pixels~%ultralytics_ros/Point2D point~%~%# conf of the keypoint~%float64 score~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
