...
(cl:defclass <Mask> (roslisp-msg-protocol:ros-message)
  ((height
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector ultralytics_ros-msg:Point2D)
   :initform (cl:make-array 0 :element-type 'ultralytics_ros-msg:Point2D :initial-element (cl:make-instance 'ultralytics_ros-msg:Point2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Mask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<Mask> is deprecated: use ultralytics_ros-msg:Mask instead.")))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Mask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:height-val is deprecated.  Use ultralytics_ros-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Mask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:width-val is deprecated.  Use ultralytics_ros-msg:width instead.")
  (width m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Mask>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ultralytics_ros-msg:Point2D))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Mask>)))
  ...
  (cl:format cl:nil "# segmentation mask for one instance~%~%# size of the original image~%int32 height~%int32 width~%~%# mask data represeted by the points of the border of the mask~%ultralytics_ros/Point2D[] data~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Mask)))
  "Returns full string definition for message of type 'Mask"
  (cl:format cl:nil "# segmentation mask for one instance~%~%# size of the original image~%int32 height~%int32 width~%~%# mask data represeted by the points of the border of the mask~%ultralytics_ros/Point2D[] data~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
