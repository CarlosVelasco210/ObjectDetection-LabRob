...
(cl:defclass <Detection> (roslisp-msg-protocol:ros-message)
  ((class_id
   ...
   (bbox
    :reader bbox
    :initarg :bbox
    :type ultralytics_ros-msg:BoundingBox2D
    :initform (cl:make-instance 'ultralytics_ros-msg:BoundingBox2D))
   (bbox3d
    :reader bbox3d
    :initarg :bbox3d
    :type ultralytics_ros-msg:BoundingBox3D
    :initform (cl:make-instance 'ultralytics_ros-msg:BoundingBox3D))
   (mask
    :reader mask
    :initarg :mask
    :type ultralytics_ros-msg:Mask
    :initform (cl:make-instance 'ultralytics_ros-msg:Mask))
   (keypoints
    :reader keypoints
    :initarg :keypoints
    :type ultralytics_ros-msg:KeyPoint2DArray
    :initform (cl:make-instance 'ultralytics_ros-msg:KeyPoint2DArray))
   (keypoints3d
    :reader keypoints3d
    :initarg :keypoints3d
    :type ultralytics_ros-msg:KeyPoint3DArray
    :initform (cl:make-instance 'ultralytics_ros-msg:KeyPoint3DArray)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<Detection> is deprecated: use ultralytics_ros-msg:Detection instead.")))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:class_id-val is deprecated.  Use ultralytics_ros-msg:class_id instead.")
  (class_id m))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:class_name-val is deprecated.  Use ultralytics_ros-msg:class_name instead.")
  (class_name m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:score-val is deprecated.  Use ultralytics_ros-msg:score instead.")
  (score m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:id-val is deprecated.  Use ultralytics_ros-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'bbox-val :lambda-list '(m))
(cl:defmethod bbox-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:bbox-val is deprecated.  Use ultralytics_ros-msg:bbox instead.")
  (bbox m))

(cl:ensure-generic-function 'bbox3d-val :lambda-list '(m))
(cl:defmethod bbox3d-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:bbox3d-val is deprecated.  Use ultralytics_ros-msg:bbox3d instead.")
  (bbox3d m))

(cl:ensure-generic-function 'mask-val :lambda-list '(m))
(cl:defmethod mask-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:mask-val is deprecated.  Use ultralytics_ros-msg:mask instead.")
  (mask m))

(cl:ensure-generic-function 'keypoints-val :lambda-list '(m))
(cl:defmethod keypoints-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:keypoints-val is deprecated.  Use ultralytics_ros-msg:keypoints instead.")
  (keypoints m))

(cl:ensure-generic-function 'keypoints3d-val :lambda-list '(m))
(cl:defmethod keypoints3d-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:keypoints3d-val is deprecated.  Use ultralytics_ros-msg:keypoints3d instead.")
  (keypoints3d m))
