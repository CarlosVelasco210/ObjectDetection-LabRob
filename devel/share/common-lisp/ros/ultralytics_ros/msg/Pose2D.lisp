...
(cl:defmethod cl:initialize-instance :after ((m <Pose2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<Pose2D> is deprecated: use ultralytics_ros-msg:Pose2D instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:position-val is deprecated.  Use ultralytics_ros-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Pose2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ultralytics_ros-msg:theta-val is deprecated.  Use ultralytics_ros-msg:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose2D>)))
  ...
  (cl:format cl:nil "# 2D position in pixel coordinates~%~%ultralytics_ros/Point2D position~%float64 theta~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose2D)))
  "Returns full string definition for message of type 'Pose2D"
  (cl:format cl:nil "# 2D position in pixel coordinates~%~%ultralytics_ros/Point2D position~%float64 theta~%================================================================================~%MSG: ultralytics_ros/Point2D~%# 2D point in pixel coordinates~%~%float64 x~%float64 y~%~%"))
