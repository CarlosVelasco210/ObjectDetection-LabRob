...
(cl:defmethod cl:initialize-instance :after ((m <KeyPoint3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyPoint3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ultralytics_ros-msg:<KeyPoint3D> is deprecated: use ultralytics_ros-msg:KeyPoint3D instead.")))
