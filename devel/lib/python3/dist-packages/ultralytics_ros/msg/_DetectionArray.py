...
"""autogenerated by genpy from ultralytics_ros/DetectionArray.msg. Do not edit."""
import codecs
import sys
...
class DetectionArray(genpy.Message):
  _md5sum = "a083f705d50596d301a4f958a078d859"
  _type = "ultralytics_ros/DetectionArray"
...
float64 score"""
  ...
  _slot_types = ['std_msgs/Header','ultralytics_ros/Detection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ultralytics_ros.msg.Detection()
        start = end
        end += 4
        ...
        _v24.data = []
        for i in range(0, length):
          val3 = ultralytics_ros.msg.Point2D()
          _x = val3
          start = end
          end += 16
          (_x.x, _x.y,) = _get_struct_2d().unpack(str[start:end])
        ...
        _v25.data = []
        for i in range(0, length):
          val3 = ultralytics_ros.msg.KeyPoint2D()
          start = end
          end += 4
        ...
        _v27.data = []
        for i in range(0, length):
          val3 = ultralytics_ros.msg.KeyPoint3D()
          start = end
          end += 4
          (val3.id,) = _get_struct_i().unpack(str[start:end])
          _v28 = val3.point
